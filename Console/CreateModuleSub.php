...
class CreateModuleSub extends Command
{
    ...
    public function handle()
    {
        ...
        $storeAction = str_replace('//use .. ;', "use IDS\\$this->module\\Models\\" . $this->name . ";\nuse IDS\\$this->module\\Requests\\" . $this->name . "StoreRequest;", $storeAction);
        ...
        $updateAction = str_replace('//use .. ;', "use IDS\\$this->module\\Models\\" . $this->name . ";\nuse IDS\\$this->module\\Requests\\" . $this->name . "UpdateRequest;",  $updateAction);
        ...
        $deleteAction = str_replace('//use .. ;', "use IDS\\$this->module\\Models\\" . $this->name . ";", $deleteAction);
        ...
        $routeApiFile = base_path() . "/modules/" . $this->module . "/api.php";
        $routeApi = file_get_contents($routeApiFile);
        $routeApi = str_replace('//add more class here ...', "use IDS\\" . $this->module . "\\Controllers\\" . $this->name . "Controller;\n//add more class here ...", $routeApi);
