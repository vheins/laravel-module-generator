...
class CreateModule extends Command
{
    ...
    public function handle()
    {
        ...
        // $storeAction = str_replace('//use .. ;', "use " . config('modules.namespace') . "\\$this->module\\Models\\" . $this->module . ";\nuse " . config('modules.namespace') . "\\$this->module\\Requests\\" . $this->module . "StoreRequest;", $storeAction);
        ...
        // $updateAction = str_replace('//use .. ;', "use " . config('modules.namespace') . "\\$this->module\\Models\\" . $this->module . ";\nuse " . config('modules.namespace') . "\\$this->module\\Requests\\" . $this->module . "UpdateRequest;",  $updateAction);
        ...
        // $deleteAction = str_replace('//use .. ;', "use " . config('modules.namespace') . "\\$this->module\\Models\\" . $this->module . ";", $deleteAction);
